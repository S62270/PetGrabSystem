                    ...
                    <tbody>
                        <c:forEach var="vendor" items="${listVendor}">
                            <tr>
                                ...
                                <td><a href="/PetGrabSystem/VendorServlet?action=edit&amp;id=${vendor.id}" class="btn btn-warning">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;<!-- comment -->
                                    <a href="/PetGrabSystem/VendorServlet?action=delete&amp;id=${vendor.id}" class="btn btn-secondary">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
